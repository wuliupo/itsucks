...
//			this.regExpFilterList.setModel(model);
    ...
    private void initComponents() {
        ...
        regExpFilterList.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
        ...
        regExpFilterAddButton.addActionListener(new java.awt.event.ActionListener() {
        ...
        regExpFilterRemoveButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        regExpFilterMoveUpButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        regExpFilterMoveDownButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                regExpFilterMoveDownButtonActionPerformed(evt);
            }
        });

        editRegExpFilterPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Regular Expression Filter"));

        editRegExpFilterNameLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        editRegExpFilterNameLabel.setText("Filter Name:");

        editRegExpFilterNameField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                editRegExpFilterNameFieldFocusLost(evt);
            }
        });

        editRegExpFilterDescriptionLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        editRegExpFilterDescriptionLabel.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        editRegExpFilterDescriptionTextArea.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                editRegExpFilterDescriptionTextAreaFocusLost(evt);
            }
        });
        editRegExpFilterDescriptionPane.setViewportView(editRegExpFilterDescriptionTextArea);

        editRegExpFilterRegExpLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        editRegExpFilterRegExpLabel.setText("Regular Expression, partial match:");
        ...
        editRegExpFilterRegExpTextArea.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                editRegExpFilterRegExpTextAreaFocusLost(evt);
            }
        });
        editRegExpFilterRegExpPane.setViewportView(editRegExpFilterRegExpTextArea);

        editRegExpFilterOpenRegExpEditorButton.setFont(new java.awt.Font("Dialog", 0, 10));
        editRegExpFilterOpenRegExpEditorButton.setText("Open Regular Expression Editor");
        editRegExpFilterOpenRegExpEditorButton.setMargin(new java.awt.Insets(2, 4, 2, 4));
        editRegExpFilterOpenRegExpEditorButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                editRegExpFilterOpenRegExpEditorButtonActionPerformed(evt);
            }
        });

        editRegExpFilterMatchPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Action in case of match"));

        editRegExpFilterMatchStatusChangeLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        editRegExpFilterMatchStatusChangeLabel.setText("Change status:");

        editRegExpFilterMatchStatusChangeComboBox.setFont(new java.awt.Font("Dialog", 0, 12));
        editRegExpFilterMatchStatusChangeComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                editRegExpFilterMatchStatusChangeComboBoxActionPerformed(evt);
            }
        });

        editRegExpFilterMatchPrioChangeLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        editRegExpFilterMatchPrioChangeLabel.setText("Priority change:");

        editRegExpFilterMatchPrioChangeTextField.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        editRegExpFilterMatchPrioChangeTextField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
        ...
        editRegExpFilterMatchPanelLayout.linkSize(new java.awt.Component[] {editRegExpFilterMatchPrioChangeLabel, editRegExpFilterMatchStatusChangeLabel}, org.jdesktop.layout.GroupLayout.HORIZONTAL);

        editRegExpFilterMatchPanelLayout.setVerticalGroup(
            editRegExpFilterMatchPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(editRegExpFilterMatchPanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(editRegExpFilterMatchPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(editRegExpFilterMatchStatusChangeLabel)
                    .add(editRegExpFilterMatchStatusChangeComboBox, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(editRegExpFilterMatchPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(editRegExpFilterMatchPrioChangeLabel)
        ...
        editRegExpFilterNoMatchPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Action in case of no match"));

        editRegExpFilterNoMatchStatusChangeLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        editRegExpFilterNoMatchStatusChangeLabel.setText("Change status:");

        editRegExpFilterNoMatchStatusChangeComboBox.setFont(new java.awt.Font("Dialog", 0, 12));
        editRegExpFilterNoMatchStatusChangeComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                editRegExpFilterNoMatchStatusChangeComboBoxActionPerformed(evt);
            }
        });

        editRegExpFilterNoMatchPrioChangeLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        editRegExpFilterNoMatchPrioChangeLabel.setText("Priority change:");

        editRegExpFilterNoMatchPrioChangeTextField.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        editRegExpFilterNoMatchPrioChangeTextField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
        ...
        editRegExpFilterNoMatchPanelLayout.setHorizontalGroup(
            editRegExpFilterNoMatchPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        ...
        editRegExpFilterNoMatchPanelLayout.setVerticalGroup(
            ...
            .add(editRegExpFilterNoMatchPanelLayout.createSequentialGroup()
                ...
                .add(editRegExpFilterNoMatchPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(editRegExpFilterNoMatchStatusChangeComboBox, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(editRegExpFilterNoMatchStatusChangeLabel))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(editRegExpFilterNoMatchPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(editRegExpFilterNoMatchPrioChangeLabel)
        ...
        org.jdesktop.layout.GroupLayout editRegExpFilterPanelLayout = new org.jdesktop.layout.GroupLayout(editRegExpFilterPanel);
        editRegExpFilterPanel.setLayout(editRegExpFilterPanelLayout);
        editRegExpFilterPanelLayout.setHorizontalGroup(
            editRegExpFilterPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(editRegExpFilterPanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(editRegExpFilterPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, editRegExpFilterRegExpPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 536, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, editRegExpFilterPanelLayout.createSequentialGroup()
                        .add(editRegExpFilterMatchPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(editRegExpFilterNoMatchPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .add(editRegExpFilterPanelLayout.createSequentialGroup()
                        .add(editRegExpFilterNameLabel)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(editRegExpFilterNameField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 138, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(editRegExpFilterDescriptionLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 111, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(editRegExpFilterDescriptionPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE))
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, editRegExpFilterPanelLayout.createSequentialGroup()
                        .add(editRegExpFilterRegExpLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 361, Short.MAX_VALUE)
                        .add(175, 175, 175))
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, editRegExpFilterOpenRegExpEditorButton))
                .addContainerGap())
        );
        editRegExpFilterPanelLayout.setVerticalGroup(
            editRegExpFilterPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(editRegExpFilterPanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(editRegExpFilterPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(editRegExpFilterPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                        .add(editRegExpFilterNameLabel)
                        .add(editRegExpFilterNameField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(editRegExpFilterDescriptionLabel))
                    .add(editRegExpFilterDescriptionPane, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 41, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(editRegExpFilterRegExpLabel)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(editRegExpFilterRegExpPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 58, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, editRegExpFilterPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(layout.createSequentialGroup()
                        .add(regExpFilterPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 515, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(regExpFilterRemoveButton)
                            .add(regExpFilterAddButton)
                            .add(regExpFilterMoveUpButton)
                            .add(regExpFilterMoveDownButton)))
                    .add(org.jdesktop.layout.GroupLayout.LEADING, regExpFilterChainExplanationLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 572, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, regExpFilterChainLabel))
                .addContainerGap())
        );

        layout.linkSize(new java.awt.Component[] {regExpFilterAddButton, regExpFilterRemoveButton}, org.jdesktop.layout.GroupLayout.HORIZONTAL);

        layout.linkSize(new java.awt.Component[] {regExpFilterMoveDownButton, regExpFilterMoveUpButton}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(regExpFilterChainExplanationLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 35, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        .add(regExpFilterAddButton)
        ...
        layout.linkSize(new java.awt.Component[] {regExpFilterAddButton, regExpFilterRemoveButton}, org.jdesktop.layout.GroupLayout.VERTICAL);

        layout.linkSize(new java.awt.Component[] {regExpFilterMoveDownButton, regExpFilterMoveUpButton}, org.jdesktop.layout.GroupLayout.VERTICAL);
